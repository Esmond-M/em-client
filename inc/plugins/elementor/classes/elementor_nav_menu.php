...
namespace inc\plugins\elementor\classes\elementor_nav_menu;

if (!class_exists('EMCLIENT_elementor_nav_menu')) {
    class EMCLIENT_elementor_nav_menu extends \Elementor\Widget_Base
    {
    ...
    use inc\plugins\elementor\classes\elementor_nav_menu;